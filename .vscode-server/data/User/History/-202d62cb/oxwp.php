              ...
              <div class="card-body">
                <form action="/admin/faturaNova.php" method="get">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" style="width: 100%;" id="NIF" name="NIF" value="<?=$nif?>">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" style="width: 100%;" id="CodigoProcedimento" name="CodigoProcedimento" value="<?=$proc?>">
