...
//Usar com o sor Lira.  SELECT Fornecedores.NIF, Fornecedores.Nome, NumerodeTelefone, Email, ifnull(sum(ValorTotal),0) total FROM `Fornecedores` left join Fatura ON Fornecedores.NIF = Fatura.NIF left JOIN Procedimento ON Fatura.CodigoProcedimento = Procedimento.Codigoprocedimento GROUP BY Fornecedores.NIF, Fornecedores.Nome;
