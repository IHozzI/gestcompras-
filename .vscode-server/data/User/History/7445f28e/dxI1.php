...
$table->setTitle("Lista de Procedimentos/Concursos");

//select the table in the datebase
//SELECT `Data`, `Codigoprocedimento`, `Nome`, `ValorTotal` FROM `Procedimento` WHERE 1
$table->prepareTable("Procedimento");

//list of fields for list, new, edit and import records
$table->setFieldsAtive("Codigoprocedimento, Data, Nome, ValorTotal",'list');
$table->setFieldsAtive("Data, Nome, ValorTotal", 'new');
$table->setFieldsAtive("Data, Nome, ValorTotal", 'edit');
$table->setFieldsAtive("Data, Nome, ValorTotal", 'csv');
