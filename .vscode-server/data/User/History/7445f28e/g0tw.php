...
//SELECT `Ano`, `Codigoprocedimento`, `Nome`, `ValorTotal` FROM `Procedimento` WHERE 1
$table->prepareTable("Procedimento");

//list of fields for list, new, edit and import records
$table->setFieldsAtive("Codigoprocedimento, Ano, Nome, ValorTotal",'list');
$table->setFieldsAtive("Ano, Nome, ValorTotal", 'new');
$table->setFieldsAtive("Ano, Nome, ValorTotal", 'edit');
$table->setFieldsAtive("Ano, Nome, ValorTotal", 'csv');
