...
$table->setTitle("Lista de Artigos");

//select the table in the datebase
//SELECT `Nome`, `CodigoArtigo`, `CodigoFamilia` FROM `Artigos` WHERE 1
$table->prepareTable("Artigos");

//list of fields for list, new, edit and import records
$table->setFieldsAtive("Nome, CodigoArtigo,CodigoFamilia",'list');
$table->setFieldsAtive("Nome,CodigoFamilia", 'new');
$table->setFieldsAtive("Nome,CodigoFamilia", 'edit');
$table->setFieldsAtive("Nome,CodigoFamilia", 'csv');
...
$table->setFieldList("CodigoFamilia",1," SELECT `id`,`type` FROM `tabUsersTypes` ORDER BY `type`");
