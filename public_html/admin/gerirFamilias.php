...
$table->setTitle("Familias");

//select the table in the datebase
//SELECT SELECT `Nome`, `CodigoFamilia` FROM `Familias` WHERE 1
$table->prepareTable("Familias");

//list of fields for list, new, edit and import records
$table->setFieldsAtive("Nome, CodigoFamilia",'list');
$table->setFieldsAtive("Nome", 'new');
$table->setFieldsAtive("Nome", 'edit');
$table->setFieldsAtive("Nome", 'csv');
