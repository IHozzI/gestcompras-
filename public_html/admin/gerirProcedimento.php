...
$table->setFieldsAtive("Codigoprocedimento, Nome, TipoProcedimento, ValorTotal, NIF, Ano,",'list');
$table->setFieldsAtive("Nome, TipoProcedimento, TipoContrato, CPV, ValorTotal, NIF, Data, Ano, Link", 'new');
$table->setFieldsAtive("Nome, TipoProcedimento, TipoContrato, CPV, ValorTotal, NIF, Data, Ano, Link", 'edit');
$table->setFieldsAtive("Nome, TipoProcedimento, TipoContrato, CPV, ValorTotal, NIF, Data, Ano, Link", 'csv');
