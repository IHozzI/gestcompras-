...
$table->setTemplate(_CAMINHO_ADMIN . "tabela.php");

//Set title of the list
$table->setTitle("utilizadores");

//select the table in the datebase
//SELECT `Processo`, `Nome`, `Email`, `Imagem`, `Tipo` FROM `Utilizadores` WHERE 1
$table->prepareTable("Utilizadores");

//list of fields for list, new, edit and import records
$table->setFieldsAtive("Processo,Nome,Email,Imagem,Tipo",'list');
$table->setFieldsAtive("Processo,Nome,Email,Imagem,Tipo", 'new');
$table->setFieldsAtive("Processo,Nome,Email,Imagem,Tipo", 'edit');
$table->setFieldsAtive("Processo,Nome,Email,Imagem,Tipo", 'csv');
...
$table->setFieldList("Tipo",2,"1=>Administrador,0=>Inactive");
