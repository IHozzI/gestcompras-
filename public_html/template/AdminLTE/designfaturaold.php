...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="/template/AdminLTE/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
...
<body>
    <div class="container">
        ...
        <form action="processar_fatura.php" method="post">
            <div>
                <label for="numeroFatura">Número da Fatura:</label>
                <input type="text" id="numeroFatura" name="numeroFatura" required>
            </div>

            <div>
                <label for="dataFatura">Data:</label>
                <input type="date" id="dataFatura" name="dataFatura" required>
            </div>

            <div>
                <label for="nifCliente">NIF do Cliente:</label>
                <input type="text" id="nifCliente" name="nifCliente" required>
            </div>

            <div>
                <label for="codigoProcedimento">Código de Procedimento:</label>
